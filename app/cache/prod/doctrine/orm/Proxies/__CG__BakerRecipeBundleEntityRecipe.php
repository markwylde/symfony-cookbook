...
namespace Proxies\__CG__\Baker\RecipeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Recipe extends \Baker\RecipeBundle\Entity\Recipe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'author', 'content', 'photo', 'tags', 'comments', 'created', 'updated');
        }
